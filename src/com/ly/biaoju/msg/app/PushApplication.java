...
import com.ly.biaoju.msg.baidupush.server.BaiduPush;
...
public class PushApplication extends FrontiaApplication {
	...
	public  static String SECRIT_KEY = "";
...
//		CrashHandler.getInstance().init(this);
	...
	private void initData() {
		...
		API_KEY = getMetaValue(PushApplication.this, "api_key");
		SECRIT_KEY = getMetaValue(PushApplication.this, "secrit_key");
