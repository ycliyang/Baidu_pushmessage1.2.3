...
import com.ly.biaoju.msg.common.util.DialogUtil;
import com.ly.biaoju.msg.common.util.NetUtil;
import com.ly.biaoju.msg.common.util.SendMsgAsyncTask;
import com.ly.biaoju.msg.common.util.SendMsgAsyncTask.OnSendScuessListener;
...
//	        if (!BaiduUtils.hasBind(getApplicationContext())) {
	            PushManager.startWork(getApplicationContext(),
	                    ...
	                    BaiduUtils.getMetaValue(FirstSetActivity.this, "api_key"));
